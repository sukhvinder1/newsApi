package com.news.application.facade.constant;
...
public class AppConstant {
    ...
    public static final String TECHNEWSWORLD = "technewsworld";
    public static final String TIMESOFINDIA = "timesOfIndia";
